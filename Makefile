...
SOURCES = \
	__init__.py \
	select_agric.py select_agric_dialog.py

PLUGINNAME = select_agric

PY_FILES = \
	__init__.py \
	select_agric.py select_agric_dialog.py

UI_FILES = select_agric_dialog_base.ui
...
QGISDIR=C:\Users\thomaz.costa\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
